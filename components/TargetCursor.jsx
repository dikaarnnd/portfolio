...
const TargetCursor = ({
  ...
  const moveCursor = useCallback((x, y, speed = 0.1) => {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ willChange: "transform" }}
      />
      {/* Custom border bulat dashed */}
      <div
        className="absolute left-1/2 top-1/2 w-[25px] h-[25px] rounded-full border-[6px] border-dashed border-[#00ff99] transform -translate-x-1/2 -translate-y-1/2"
        style={{ willChange: "transform" }}
      />
      {/* <div
